...
toplevel_suite.addTest(topleveltests.ToplevelTests("test_baseline"))
toplevel_suite.addTest(topleveltests.ToplevelTests("test_setup_multi"))
toplevel_suite.addTest(topleveltests.ToplevelTests("test_setup_color_components"))
